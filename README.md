...
- `og:url` – set to your deployed URL, e.g. `https://your-project-name.vercel.app/`.
...
This project is intended as a DJSPP portfolio piece and learning project. Adapt or extend it as needed for your coursework or personal portfolio.